...
/** Find user id by valid password reset token hash (standalone Mongo; avoids Prisma client lag on schema add). */
async function mongoUserFindByPasswordResetToken(tokenHash) {
...
module.exports = {
  ...
  mongoUserFindByPasswordResetToken
};
