...
function fieldUpdateToMongoSet(prismaShape) {
  ...
  if (d.venueResponse !== undefined) $set.venue_response = d.venueResponse;
  ...
  if (d.pendingChanges !== undefined) $set.pending_changes = d.pendingChanges;
  if (d.pendingChangeRequestedAt !== undefined) $set.pending_change_requested_at = d.pendingChangeRequestedAt;
...
function mapFieldDocAndOwner(doc, ownerDoc) {
  ...
  return {
    ...
    venueResponse: doc.venue_response ?? null,
    ...
    pendingChanges: doc.pending_changes ?? null,
    pendingChangeRequestedAt: doc.pending_change_requested_at ?? null,
...
async function mongoFieldCreateAndFetch(prismaData) {
  ...
  const doc = {
    ...
    venue_response: prismaData.venueResponse ?? null,
